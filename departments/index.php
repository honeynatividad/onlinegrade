                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php foreach($deparment->departmentList() as $a): ?>
                                        <tr class="odd gradeX">
											...
											<td><a class="btn btn-primary" href="edit.php?id=<?php echo $a['department_id'] ?>">Edit</a> <a class="btn btn-success" href="activate.php?id=<?php echo $a['department_id'] ?>">Activate</a> <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['department_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
