                                ...
                                <div class="col-lg-12">
                                    <form role="form" action="edit.php" method="POST">
										...
										<div class="form-group">
                                            <label>Section</label>
											<input type="text" name="name" class="form-control" value="<?php echo $section->name ?>">											
											
                                        </div>
										<div class="form-group">
                                            <label>Course</label>                                            
											<select name="course_id" class="form-control">
                                            <?php $section->courseData($id) ?>
                                            	<option value="<?php echo $section->course_id ?>"><?php echo $section->course_name ?></option>
											
											<?php foreach($section->courseList() as $a): ?>
