                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php foreach($grading->gradingSubject($t_id) as $a): ?>
                                        ...
                                        <tr class="odd gradeX">
											...
											<td>
												<a class="btn btn-primary" href="update.php?sid=<?php echo $a['subject_load_id'] ?>">Update</a> 
												<a class="btn btn-primary" href="grades.php?sid=<?php echo $a['subject_load_id'] ?>">Add Grades</a> 
												<a class="btn btn-success" href="activate.php?id=<?php echo $a['section_id'] ?>">Activate</a> 
												<a class="btn btn-success" href="deactivate.php?id=<?php echo $a['section_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
