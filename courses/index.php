    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">E-Blast</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
              <div class="col-lg-12">
                    <h1 class="page-header">Deparments Management </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php foreach($course->courseList() as $a): ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $a['course_id'] ?></td>
                                            <td><?php echo $a['name'] ?></td>
                                            <td><?php echo $a['description'] ?></td>											
											<td><?php echo $a['status'] ?></td>
											<td><a class="btn btn-primary" href="edit.php?id=<?php echo $a['course_id'] ?>">Edit</a> <a class="btn btn-success" href="activate.php?id=<?php echo $a['course_id'] ?>">Activate</a> <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['course_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
