...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
              <div class="col-lg-12">
                    <h1 class="page-header">Subjects Management </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php foreach($subject->subjectList() as $a): ?>
                                        <tr class="odd gradeX">
											...
											<td><a class="btn btn-primary" href="edit.php?id=<?php echo $a['subject_id'] ?>">Edit</a> <a class="btn btn-success" href="activate.php?id=<?php echo $a['subject_id'] ?>">Activate</a> <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['subject_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
