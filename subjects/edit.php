...
$subject->courseListName($subject->course_id);
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject->subjectEdit($subject->subject_id);
							...
							<div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="edit.php" method="POST">
                                        <input type="hidden" value="<?php echo $id ?>" name="subject_id">

										 <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" name='name' value="<?php echo $subject->name ?>">
                                            
                                        </div>

										 <div class="form-group">
                                            <label>Code</label>
                                            <input class="form-control" name='code' value="<?php echo $subject->code ?>">
                                        </div>                                        
										 
                                        <div class="form-group">
                                            <label>Unit</label>
                                            <input class="form-control" name='unit' value="<?php echo $subject->unit ?>">
                                        </div>                                    
                                        <div class="form-group">
                                            <label>Course</label>
                                            <select name="course_id">
                                            <option value="<?php echo $subject->course_id ?>"><?php echo $subject->course_name ?></option>
                                            <?php foreach($subject->courseListData() as $a): ?>
