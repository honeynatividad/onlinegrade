                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php foreach($load->teacherList() as $a): ?>
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><a class="btn btn-primary" href="list_subjects.php?id=<?php echo $a['teacher_id'] ?>">List of Subject</a> <a class="btn btn-success" href="activate.php?id=<?php echo $a['teacher_id'] ?>">Activate</a> <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['subject_load_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
