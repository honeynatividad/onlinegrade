                ...
                <div class="col-lg-12">
                    <div class="panel panel-default"> 
                        <div class="panel-heading">
                            <a class="btn btn-primary" href="<?php echo $url ?>subject_students/add.php?t_id=<?php echo $t_id ?>&sec_id=<?php echo $sec_id ?>&sub_id=<?php echo $sub_id ?>">Add</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php foreach($load->subjectListStudents($sub_id,$sec_id) as $a): ?>
                                        ...
                                        <tr class="odd gradeX">
											...
											<td> <a class="btn btn-primary" href="view_student.php?id=<?php echo $a['section_id'] ?>">View</a> <a class="btn btn-success" href="activate.php?id=<?php echo $a['student_id'] ?>">Activate</a> <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['student_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
