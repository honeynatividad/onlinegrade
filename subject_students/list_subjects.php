                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    foreach($load->subjectList($id) as $a): ?>
                                    
                                        <tr class="odd gradeX">
                                            <td><?php echo $a['subject_id'] ?></td>
                                            <td><?php echo $a['name'] ?> - <?php echo $a['code'] ?></td>
                                            <td><?php echo $a['section_name'] ?></td>
											<td><a class="btn btn-primary" href="list_students.php?t_id=<?php echo $id ?>&sec_id=<?php echo $a['section_id'] ?>&sub_id=<?php echo $a['subject_id'] ?>">List of Students</a> <a class="btn btn-primary" href="list_subjects.php?id=<?php echo $a['section_id'] ?>">Add Students</a> <a class="btn btn-success" href="activate.php?id=<?php echo $a['teacher_id'] ?>">Activate</a> <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['subject_load_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
