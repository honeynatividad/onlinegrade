            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <p>First Name: <?php echo $teacher->first_name ?></p>    
                        <p>Last Name: <?php echo $teacher->last_name ?></p>
                        <p>Middle Name: <?php echo $teacher->middle_name ?></p>
                        <p>Birthday: <?php echo $teacher->birthdate ?></p>
                        <p>Email Add: <?php echo $teacher->email_add ?></p>
                        <p>Contact: <?php echo $teacher->contact_no ?></p>
                        <p>Address: <?php echo $teacher->address ?></p>
                        <p>Department: <?php echo $teacher->d_name ?></p>
                        <img src="<?php echo $url ?>admin/teachers/<?php echo $teacher->photo ?>" />
                            <!-- /.table-responsive -->
