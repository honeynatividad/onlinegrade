                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php foreach($student->studentList() as $a): ?>
                                    <?php
                                        $student->courseListName($a['course']);
                                    ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $a['student_no'] ?></td>
                                            <td><?php echo $a['first_name'] ?></td>
                                            <td><?php echo $a['last_name'] ?></td>											
											<td><?php echo $student->course_name ?></td>
                                            <td><?php echo $a['status']; ?></td>											
                                            
											<td><a class="btn btn-primary" href="edit.php?id=<?php echo $a['student_id'] ?>">Edit</a> <a class="btn btn-success" href="activate.php?id=<?php echo $a['student_id'] ?>">Activate</a> <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['student_id'] ?>">Deactivate</a></td>
                                        </tr>
                                       <?php endforeach; ?>
